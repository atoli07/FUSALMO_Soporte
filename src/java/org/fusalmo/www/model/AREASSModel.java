...
public class AREASSModel {
    
     public int checkRecurso(String finalId, int resultCount, StringBuilder id){
        
        AreaEntity returnResource = buscarManteId(finalId);
    ...
    public  List<AreaEntity> listarManteActivos(){
         EntityManager em= JPAUtil.getEntityManager();
         try{
            Query consulta= em.createNamedQuery("AreaEntity.findByIsDeleted");
    ...
    public AreaEntity buscarManteId(String id) {
        ...
        try {
            ...
            //em.clear();
            //em.flush();
            AreaEntity recurso = em.find(AreaEntity.class, id);
